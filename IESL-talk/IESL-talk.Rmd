...
date: </br></br> Priyanga Dilini Talagala </br>`r anicon::faa("globe", animate="horizontal", colour= "green")` <span style="color:lightgreen">prital.netlify.app</span></br></br> </br> <span style="font-size:15.0pt; color:lightgreen">28/09/2024</span></br> <span style="font-size:13.0pt; color:lightgreen">The slides are powered by xaringan R package </span>
output:
...
Input Data Structure: Time series data from sensors (e.g., accelerometers, strain gauges) measuring vibrations, stresses, and displacements of a structure over time.
